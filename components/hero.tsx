          ...
          <div className="rounded-[28px] border border-[#d8d2ca] bg-[#e9e4dd] p-6 shadow-[0_25px_60px_rgba(0,0,0,0.06)] lg:p-8">
            <div className="space-y-4">
              ...
              <button
                ...
                className="group mt-6 flex w-full items-center justify-center gap-2 rounded-md bg-[#2d211b] px-4 py-4 text-sm font-medium lowercase text-white transition hover:bg-black"
              >
                find my ride
